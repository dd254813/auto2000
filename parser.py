...
class Bot:
    ...
    Информация со страницы (ячеек таблицы) пишется во временные словари (структура -  вин номер : {Номер ТО : {'Заказ наряд':001, 'дата': 01-01-2019,'пробег':12345,'диллер':56000}})
